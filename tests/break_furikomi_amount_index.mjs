...
withBreak('収録範囲の申告を消した（他行宛30区分だけ、という前提が読者に見えなくなる）',
  (h) => h.replace('この表が扱うのは<b>他行宛・30区分</b>だけです。', ''),
  '収録範囲の申告');

withBreak('「推測で当てはめない」の注意を消した',
  (h) => h.replace('この表に当てはめず、通帳の摘要欄や銀行の料金ページでご確認ください。', ''),
  '表に当てはめず');
