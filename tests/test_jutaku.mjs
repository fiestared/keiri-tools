...
eq(calc({ type: "chuko", kubun: "nintei", year: 2021, nenmatsuZandaka: BIG }, D).beyondData, true,
  "★中古・令和3年入居は収録外");
eq(calc({ type: "chuko", kubun: "nintei", year: 2027, nenmatsuZandaka: BIG }, D).beyondData, true,
  "★中古・令和9年入居は収録外（法定済みだが1年ずつ収録する方針）");
...
{
  // 収録外の入居年（令和3年＝2021、令和9年＝2027）— 新築
  eq(calc({ kubun: "nintei", year: 2021, nenmatsuZandaka: BIG }, D).beyondData, true,
    "★令和3年入居は収録外（別の表・控除率1％）");
  eq(calc({ kubun: "nintei", year: 2027, nenmatsuZandaka: BIG }, D).beyondData, true,
    "★令和9年入居は収録外（法定済みだが1年ずつ収録する方針）");
}
...
eq(resolveGendo("nintei", 2027, false, false, D), null, "令和9年は収録外（null）");
eq(resolveGendo("nintei", 2027, false, false, D, "chuko"), null, "中古・令和9年も収録外（null）");
