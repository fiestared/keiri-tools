...
const IKUKYU_CAP_MONTH = 332454; // 育児休業給付の支給上限額（令和9年7月31日まで・LL080731保02）
...
const EXPECT_YEN = new Set([
  ...
  IKUKYU_CAP_MONTH, Math.floor(IKUKYU_CAP_MONTH / 30),         // 332,454 / 11,081（育休の上限）
...
checkRow('上限の比較', /^上限$/, ['30,887', '332,454']);
// 手取り比較
