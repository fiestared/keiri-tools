...
const MUT = [
  ...
  // ★"tasukai": 140100 は revision_2026_08（8月からの表・多数回は据え置き）にも在るので2箇所に一致する。
  //   7月までの表だけを狙うため、改行まで含めて一意にする（規則8: 壊し方も一意でなければ効かない）
  [DATA, "\"tasukai\": 140100\n", "\"tasukai\": 140200\n", "区分アの多数回該当額をずらす（7月までの表）"],
  [DATA, "\"base\": 85800", "\"base\": 88500", "8月からの表の区分ウの基準額をずらす（まだ計算には使っていないが転記ミスは落とす）"],
  [DATA, "\"supported_through\": \"2026-07\"", "\"supported_through\": \"2027-07\"", "★表の使える期間を延ばし、8月診療分に旧額で答えさせる"],
