...
const src = fs.readFileSync("docs/column/anzen-eisei-suishinsha/index.html", "utf8");
...
fs.writeFileSync("tools/tmp_figcheck_suishinsha_0824.html", html);
console.log("書き出し: tools/tmp_figcheck_suishinsha_0824.html");
