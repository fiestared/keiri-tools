...
REVS = [
    ...
    # 雇保則10条3項が本人確認書類として名指しする「健康保険法51条の3第1項に規定する書面」を
    # 逐語で照合するために足す。★足さないと check_quotes は「不一致」ではなく
    #   **測定していない**だけなのに、④に★付きで並ぶ（測定不能と不一致を混同しないため）。
    ("健康保険法", "211AC0000000070_20260801_508AC0000000031"),
]
