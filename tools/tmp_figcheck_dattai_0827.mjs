...
const src = fs.readFileSync("docs/column/dattai-ichijikin/index.html", "utf8");
...
fs.writeFileSync("tools/tmp_figcheck_dattai_0827.html", html);
console.log("書き出し: tools/tmp_figcheck_dattai_0827.html");
