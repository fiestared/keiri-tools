...
const CATEGORIES = [
  ...
  },
  {
    id: "sozoku-zoyo",
    name: "相続税・贈与税",
    desc: "贈与税がいくらからかかるか、暦年課税の速算表と早見表、非課税になるお金。",
    slugs: ["zoyozei-ikura"],
  },
  {
    id: "kyuyo",
...
const STATIC_PAGES = [
  "", "tedori/", "kabe/", "iryohi/", "sozokuzei/", "zoyozei/", "jutaku/", "furusato/", "shobyo/", "shussan/", "ikuji/", "papa-ikukyu/", "juminzei/", "shakai-hoken/", "gensen-choshu/", "kihonteate/", "taishokukin/", "zangyodai/", "shohizei/", "eigyobi/",
