...
const CATEGORIES = [
  ...
  },
  {
    id: "kyuyo",
    name: "給与計算・手取り",
    desc: "額面から手取りまでの引かれ方、残業代・通勤手当・住民税の実務と、36協定による労働時間の上限、フレックスタイム制の清算期間、裁量労働制のみなし時間、入社時に明示すべき労働条件、22時以降の深夜手当、会社都合で休ませたときの休業手当。",
    slugs: [
      "tedori-keisan", "roudou-joken-tsuchisho", "36-kyotei", "flextime", "sairyo-roudou", "zangyodai-keisan", "kotei-zangyodai", "shinya-teate", "kyugyo-teate", "tsukin-teate-hikazei",
